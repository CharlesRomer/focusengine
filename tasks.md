...
## In Progress
- [x] Build Timeline tab inside /board (phases, sub-project chips, drag, zoom, realtime) — DONE
- [ ] Timeline improvements: sub-project start dates, phase resize fix, bigger unscheduled section, calendar grid view — IN PROGRESS
